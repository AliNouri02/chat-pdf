  ...
  return (
    <div>
      <div className="bg-[#F1EAFB] py-12">
        <div className="flex justify-center text-[24px] sm:text-[64px] font-bold text-app-purple">
          <h4>Features</h4>
        </div>
        <div className="flex justify-center ml-12 sm:ml-36">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-[22px] w-[50px] sm:w-[107px] sm:h-[48px]"
            viewBox="0 0 109 52"
            fill="none"
          >
            <path
        ...
        <div className="flex flex-wrap self-center justify-items-center gap-x-4 justify-center gap-y-4 my-12 mx-4 ">
          <div className="w-full lg:w-[49%] flex justify-center lg:justify-end">
            <div className="bg-[#B0DA87] bg-opacity-50 rounded-xl max-w-xl w-full py-4 flex flex-wrap-reverse sm:grid sm:grid-cols-2 justify-center items-center pl-8 px-4">
              <div>
                ...
                <p className="text-[18px] text-[#555555]">
                  Works worldwide! BrainyPDF accepts PDFs in any language and
                  can chat in any language.
                </p>
              </div>
              <Image
                alt="Arrow"
          ...
          <div className="w-full lg:w-[49%] flex justify-center lg:justify-start">
